...
public class FirebaseFileService {
    ...
    public String saveTest(MultipartFile file) throws IOException {
        ...
        BlobId blobId = BlobId.of("hyper-sneaker.appspot.com", imageName);
        ...
        url.append("https://firebasestorage.googleapis.com/v0/b/hyper-sneaker.appspot.com/o/");
    ...
    public String deleteFile(String url) {
        try {
            ...
            Storage storage = StorageOptions.newBuilder()
                    ...
                    .build()
                    .getService();
            String bucketName = "hyper-sneaker.appspot.com";
